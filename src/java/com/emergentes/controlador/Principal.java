...
public class Principal extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        // todo los libros almacenados en el atributo gestor
        LibroDAO gestor=(LibroDAO)ses.getAttribute("gestor");
        // m VErificamos  si el atributo existe
         if(gestor==null){
         // en caso  de que no exista  se incluye el agributo
         ...
         // el controlador verifica la opcion para redireccionar el curso correspondiente
         if(op.trim().equals("")){
             response.sendRedirect("vista/listado.jsp");
         }
         if(op.trim().equals("nuevo")){
         ses=request.getSession();
         // todo los libros almacen en el atributo bestor
         Libro obj=new Libro();
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
         HttpSession ses=request.getSession();
        //todo los libros almacenanen el atributo gewestor
        LibroDAO gestor=(LibroDAO)ses.getAttribute("gestor");
        Libro obj=new Libro();
        
        //Ingrementa el comntador
